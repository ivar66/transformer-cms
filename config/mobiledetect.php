<?php
/**
 * simple configuration file for laravel mobile detect.
 */
...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | this option is the mobile devices lists
    |
    */
    'phoneDevice' => [
    ...
    'tabletDevices' => [
        ...
        'SonyTablet' => 'Sony Tablet|Sony Tablet S|SGPT12|SGPT121|SGPT122|SGPT123|SGPT111|SGPT112|SGPT113|SGPT211|SGPT213|EBRD1101|EBRD1201',
