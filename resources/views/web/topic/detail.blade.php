        ...
        <div class="col-xs-12 col-md-9 main">
            ...
            <section class="tag-header mt-20">
                <div>
                    ...
                    @endif
                    <span class="h4 tag-header-title">{{ $tag->tag_name }}</span>
                ...
                @if($tag->summary)
                <p class="tag-header-summary">{{ $tag->summary }}...</p>
                @else
            ...
            <ul class="nav nav-tabs nav-tabs-zen">
                ...
                <li @if($source_type==='articles') class="active" @endif ><a href="{{ route('web.topic.detail',['id'=>$tag->id,'source_type'=>'articles']) }}">文章</a></li>
{{--                <li @if($source_type==='details') class="active" @endif ><a href="{{ route('web.topic.detail',['id'=>$tag->id,'source_type'=>'details']) }}">百科</a></li>--}}
            </ul>
                    ...
                    @elseif($source_type==='articles')
                        @foreach($sources as $article)
                            <section class="stream-list-item">
                                ...
                                <div class="summary">
                                    <h2 class="title"><a href="{{ route('web.blog.detail',['id'=>$article->id]) }}">{{ $article->title }}</a></h2>
